...
\end{equation}
\section{Straight flush!!}
\blackcard{5}{\clubsuit}1*1 \over 2598960} = {1 \over 649745} \approx 0.0015\% \hbox{chance}
\blackcard{6}{\clubsuit}
\blackcard{7}{\clubsuit}
\blackcard{8}{\clubsuit}
\blackcard{9}{\clubsuit}
...
So you have:
\begin{equation}
  {40 \cdot 1 \cdot 1 \cdot 1 \cdot 1 \over 2598960} = {1 \over 649745} \approx 0.0015\% \hbox{chance}
\end{equation}
A royal flush, would have only four ways to start and has $0.00015\%$ chancce.
...
\redcard{J}{\heartsuit}
\blackcard{K}{\spadesuit}
cIf you don't have anything in poker, that is an high card.
